...
public class RepositorioPrestamoPersistente implements RepositorioPrestamo {
	...
	@Override
	public void agregar(Prestamo prestamo, String nombreUsuario) {

		PrestamoEntity prestamoEntity = buildPrestamoEntity(prestamo, nombreUsuario);
	...
	private PrestamoEntity buildPrestamoEntity(Prestamo prestamo, String nombreUsuario) {
		...
		prestamoEntity.setNombreUsuario(nombreUsuario);
